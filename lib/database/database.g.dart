...
class Todo extends DataClass implements Insertable<Todo> {
  ...
  @override
  int get hashCode => Object.hash(id, title, content, category, created);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Todo &&
...
class $TodosTable extends Todos with TableInfo<$TodosTable, Todo> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, title, content, category, created];
  @override
...
abstract class _$TodoDatabase extends GeneratedDatabase {
  ...
  late final TodosDao todosDao = TodosDao(this as TodoDatabase);
  @override
